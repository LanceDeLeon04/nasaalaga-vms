...
export function Sidebar({ activeView, setActiveView, userRole, isOpen = true, onClose }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { id: 'preregistered' as ActiveView,    label: 'Pet Pre-Registrations',      icon: ClipboardList, roles: ['admin', 'bahw', 'superadmin'] },
    { id: 'livestock-prereg' as ActiveView, label: 'Livestock Pre-Registrations', icon: ClipboardList, roles: ['admin', 'bahw', 'superadmin'] },
