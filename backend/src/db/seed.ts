...
const seed = async () => {
  ...
  try {
    ...
    const pets = [
      ...
      { id:'PET-003', owner_id:'OWNER-001', pet_name:'Charlie', species:'Cat', breed:'Persian', age:1, color:'White', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Cyrus Cruz', contact_number:'0917-123-4567', barangay:'Poblacion 1', address:'123 Main Street', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'None', registration_date:'2025-01-20' , pet_tag_id:'BLU-0003' },
      { id:'PET-004', owner_id:null, pet_name:'Brownie', species:'Dog', breed:'Aspin', age:4, color:'Brown', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Maria Reyes', contact_number:'0918-234-5678', barangay:'Poblacion 2', address:'Zone 3', vaccination_status:'Vaccinated', last_vaccination_date:'2024-11-10', next_vaccination_date:'2025-11-10', status:'Active', impound_status:'None', registration_date:'2024-05-12' , pet_tag_id:'BLU-0004' },
      { id:'PET-005', owner_id:null, pet_name:'Luna', species:'Cat', breed:'Puspin', age:2, color:'Gray/White', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Pedro Santos', contact_number:'0919-345-6789', barangay:'Poblacion 3', address:'Purok 2', vaccination_status:'Vaccinated', last_vaccination_date:'2025-01-05', next_vaccination_date:'2026-01-05', status:'Active', impound_status:'None', registration_date:'2024-09-20' , pet_tag_id:'BLU-0005' },
      ...
      { id:'PET-007', owner_id:null, pet_name:'Rocky', species:'Dog', breed:'German Shepherd', age:5, color:'Black/Tan', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Ana Garcia', contact_number:'0922-678-9012', barangay:'Poblacion 5', address:'Phase 1', vaccination_status:'Due Soon', last_vaccination_date:'2024-06-15', next_vaccination_date:'2025-06-15', status:'Active', impound_status:'None', registration_date:'2024-04-18' , pet_tag_id:'RED-0001' },
      { id:'PET-008', owner_id:null, pet_name:'Mimi', species:'Cat', breed:'Siamese', age:3, color:'Cream/Brown', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Jose Bautista', contact_number:'0923-789-0123', barangay:'Poblacion 6', address:'Block 4', vaccination_status:'Vaccinated', last_vaccination_date:'2024-12-20', next_vaccination_date:'2025-12-20', status:'Active', impound_status:'None', registration_date:'2024-07-22' , pet_tag_id:'BLU-0007' },
      { id:'PET-009', owner_id:null, pet_name:'Choco', species:'Dog', breed:'Aspin', age:2, color:'Chocolate', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Rosa Mendoza', contact_number:'0924-890-1234', barangay:'Balimbing', address:'Sitio 1', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'Impounded', impound_reason:'Roaming without owner', impound_date:'2025-01-10', registration_date:'2024-10-05' , pet_tag_id:'GRY-0001' },
      { id:'PET-010', owner_id:null, pet_name:'Whiskers', species:'Cat', breed:'Domestic Shorthair', age:4, color:'Orange/White', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Mario Cruz', contact_number:'0925-901-2345', barangay:'Baclas', address:'Zone 2', vaccination_status:'Vaccinated', last_vaccination_date:'2024-10-01', next_vaccination_date:'2025-10-01', status:'Active', impound_status:'None', registration_date:'2024-06-30' , pet_tag_id:'GRY-0002' },
      { id:'PET-011', owner_id:null, pet_name:'Duke', species:'Dog', breed:'Labrador Mix', age:3, color:'Yellow', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Elena Ramos', contact_number:'0926-012-3456', barangay:'Bambang', address:'Purok 3', vaccination_status:'Vaccinated', last_vaccination_date:'2025-01-20', next_vaccination_date:'2026-01-20', status:'Active', impound_status:'None', registration_date:'2024-08-14' , pet_tag_id:'GRY-0003' },
      ...
      { id:'PET-013', owner_id:null, pet_name:'Rex', species:'Dog', breed:'Rottweiler', age:4, color:'Black/Tan', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Carla Dela Cruz', contact_number:'0928-234-5678', barangay:'Cahil', address:'Zone 4', vaccination_status:'Due Soon', last_vaccination_date:'2024-05-10', next_vaccination_date:'2025-05-10', status:'Active', impound_status:'None', registration_date:'2024-03-22' , pet_tag_id:'PRP-0001' },
      ...
      { id:'PET-015', owner_id:null, pet_name:'Buddy', species:'Dog', breed:'Beagle', age:2, color:'Tricolor', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Gloria Navarro', contact_number:'0930-456-7890', barangay:'Caluangan', address:'Phase 2', vaccination_status:'Vaccinated', last_vaccination_date:'2024-09-05', next_vaccination_date:'2025-09-05', status:'Active', impound_status:'None', registration_date:'2024-05-18' , pet_tag_id:'BLU-0008' },
      { id:'PET-016', owner_id:null, pet_name:'Pepper', species:'Cat', breed:'Puspin', age:3, color:'Black', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Hector Villanueva', contact_number:'0931-567-8901', barangay:'Camastilisan', address:'Sitio 3', vaccination_status:'Vaccinated', last_vaccination_date:'2024-12-01', next_vaccination_date:'2025-12-01', status:'Active', impound_status:'None', registration_date:'2024-08-10' , pet_tag_id:'RED-0002' },
      ...
      { id:'PET-018', owner_id:null, pet_name:'Tigger', species:'Cat', breed:'Tabby', age:2, color:'Orange Striped', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Jaime Mercado', contact_number:'0933-789-0123', barangay:'Coral Ni Lopez', address:'Purok 4', vaccination_status:'Vaccinated', last_vaccination_date:'2025-01-08', next_vaccination_date:'2026-01-08', status:'Active', impound_status:'None', registration_date:'2024-10-12' , pet_tag_id:'PRP-0003' },
      { id:'PET-019', owner_id:null, pet_name:'Bolt', species:'Dog', breed:'Dalmatian Mix', age:3, color:'White/Black Spotted', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Karen Espiritu', contact_number:'0934-890-1234', barangay:'Dacanlao', address:'Block 7', vaccination_status:'Due Soon', last_vaccination_date:'2024-08-20', next_vaccination_date:'2025-08-20', status:'Active', impound_status:'None', registration_date:'2024-06-05' , pet_tag_id:'PRP-0004' },
      { id:'PET-020', owner_id:null, pet_name:'Shadow', species:'Dog', breed:'Labrador', age:4, color:'Black', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Lorenzo Bautista', contact_number:'0935-901-2345', barangay:'Dila', address:'Sitio Pulo', vaccination_status:'Vaccinated', last_vaccination_date:'2024-10-15', next_vaccination_date:'2025-10-15', status:'Active', impound_status:'None', registration_date:'2024-07-19' , pet_tag_id:'BLU-0010' },
      ...
      { id:'PET-022', owner_id:null, pet_name:'Zeus', species:'Dog', breed:'German Shepherd Mix', age:6, color:'Black/Tan', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Napoleon Castro', contact_number:'0937-123-4567', barangay:'Lumbang Calzada', address:'Purok 6', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'Impounded', impound_reason:'Aggressive behavior', impound_date:'2025-01-08', registration_date:'2024-02-28' , pet_tag_id:'RED-0003' },
      ...
      { id:'PET-026', owner_id:null, pet_name:'Ranger', species:'Dog', breed:'Aspin', age:3, color:'Brown/White', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Rodrigo Martinez', contact_number:'0941-567-8901', barangay:'Makina', address:'Sitio 2', vaccination_status:'Due Soon', last_vaccination_date:'2024-07-01', next_vaccination_date:'2025-07-01', status:'Active', impound_status:'None', registration_date:'2024-05-10' , pet_tag_id:'PRP-0006' },
      { id:'PET-027', owner_id:null, pet_name:'Princess', species:'Cat', breed:'Siamese', age:4, color:'Cream/Chocolate', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Susan Dela Rosa', contact_number:'0942-678-9012', barangay:'Matipok', address:'Zone 5', vaccination_status:'Vaccinated', last_vaccination_date:'2024-09-18', next_vaccination_date:'2025-09-18', status:'Active', impound_status:'None', registration_date:'2024-06-14' , pet_tag_id:'GRY-0006' },
      { id:'PET-028', owner_id:null, pet_name:'Samson', species:'Dog', breed:'Labrador', age:5, color:'Chocolate', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Teresita Cruz', contact_number:'0943-789-0123', barangay:'Munting Coral', address:'Purok 7', vaccination_status:'Vaccinated', last_vaccination_date:'2025-01-25', next_vaccination_date:'2026-01-25', status:'Active', impound_status:'None', registration_date:'2024-04-02' , pet_tag_id:'GRY-0007' },
      { id:'PET-029', owner_id:null, pet_name:'Kitty', species:'Cat', breed:'Puspin', age:1, color:'Black/White', gender:'Female', is_spayed:false, is_neutered:false, owner_name:'Ulysses Ramos', contact_number:'0944-890-1234', barangay:'Niyugan', address:'Phase 3', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'None', registration_date:'2025-02-10' , pet_tag_id:'GRY-0008' },
      ...
      { id:'PET-037', owner_id:null, pet_name:'Pearl', species:'Cat', breed:'Ragdoll Mix', age:3, color:'White/Gray', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Cornelio Bautista', contact_number:'0952-678-9012', barangay:'Taklang Anak', address:'Zone 3', vaccination_status:'Vaccinated', last_vaccination_date:'2024-12-22', next_vaccination_date:'2025-12-22', status:'Active', impound_status:'None', registration_date:'2024-09-12' , pet_tag_id:'PRP-0008' },
      ...
      { id:'PET-041', owner_id:null, pet_name:'Sparky', species:'Dog', breed:'Aspin', age:2, color:'Black', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Gregorio Flores', contact_number:'0956-012-3456', barangay:'Bagong Tubig', address:'Block 6', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'For Adoption', impound_reason:'Owner surrendered', impound_date:'2025-01-20', registration_date:'2024-12-01' , pet_tag_id:'PRP-0010' },
    ];
