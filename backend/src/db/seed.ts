...
const seed = async () => {
  ...
  try {
    ...
    const pets = [
      ...
      { id:'BLU-0000-00004', owner_id:null, pet_name:'Brownie', species:'Dog', breed:'Aspin', age:4, color:'Brown', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Maria Reyes', contact_number:'0918-234-5678', barangay:'Poblacion 2', address:'Zone 3', vaccination_status:'Vaccinated', last_vaccination_date:'2024-11-10', next_vaccination_date:'2025-11-10', status:'Active', impound_status:'None', registration_date:'2024-05-12' , pet_tag_id:'BLU-0000-00004' },
      ...
      { id:'GRY-0000-00002', owner_id:null, pet_name:'Whiskers', species:'Cat', breed:'Domestic Shorthair', age:4, color:'Orange/White', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Mario Cruz', contact_number:'0925-901-2345', barangay:'Baclas', address:'Zone 2', vaccination_status:'Vaccinated', last_vaccination_date:'2024-10-01', next_vaccination_date:'2025-10-01', status:'Active', impound_status:'None', registration_date:'2024-06-30' , pet_tag_id:'GRY-0000-00002' },
      ...
      { id:'PRP-0000-00001', owner_id:null, pet_name:'Rex', species:'Dog', breed:'Rottweiler', age:4, color:'Black/Tan', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Carla Dela Cruz', contact_number:'0928-234-5678', barangay:'Cahil', address:'Zone 4', vaccination_status:'Due Soon', last_vaccination_date:'2024-05-10', next_vaccination_date:'2025-05-10', status:'Active', impound_status:'None', registration_date:'2024-03-22' , pet_tag_id:'PRP-0000-00001' },
      ...
      { id:'PRP-0000-00007', owner_id:null, pet_name:'Scout', species:'Dog', breed:'Beagle Mix', age:2, color:'Brown/White', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Victoria Flores', contact_number:'0945-901-2345', barangay:'Pantay', address:'Zone 1', vaccination_status:'Vaccinated', last_vaccination_date:'2024-10-30', next_vaccination_date:'2025-10-30', status:'Active', impound_status:'None', registration_date:'2024-07-08' , pet_tag_id:'PRP-0000-00007' },
      ...
      { id:'RED-0000-00007', owner_id:null, pet_name:'Bruno', species:'Dog', breed:'Rottweiler Mix', age:3, color:'Black', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Zenaida Perez', contact_number:'0949-345-6789', barangay:'Salong', address:'Zone 2', vaccination_status:'Due Soon', last_vaccination_date:'2024-06-20', next_vaccination_date:'2025-06-20', status:'Active', impound_status:'None', registration_date:'2024-04-10' , pet_tag_id:'RED-0000-00007' },
      ...
      { id:'PRP-0000-00008', owner_id:null, pet_name:'Pearl', species:'Cat', breed:'Ragdoll Mix', age:3, color:'White/Gray', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Cornelio Bautista', contact_number:'0952-678-9012', barangay:'Taklang Anak', address:'Zone 3', vaccination_status:'Vaccinated', last_vaccination_date:'2024-12-22', next_vaccination_date:'2025-12-22', status:'Active', impound_status:'None', registration_date:'2024-09-12' , pet_tag_id:'PRP-0000-00008' },
