...
const seed = async () => {
  ...
  try {
    ...
    const pets = [
      ...
      { id:'BLU-000-00008', owner_id:null, pet_name:'Buddy', species:'Dog', breed:'Beagle', age:2, color:'Tricolor', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Gloria Navarro', contact_number:'0930-456-7890', barangay:'Caluangan', address:'Phase 2', vaccination_status:'Vaccinated', last_vaccination_date:'2024-09-05', next_vaccination_date:'2025-09-05', status:'Active', impound_status:'None', registration_date:'2024-05-18' , pet_tag_id:'BLU-0008' },
      ...
      { id:'PRP-000-00004', owner_id:null, pet_name:'Bolt', species:'Dog', breed:'Dalmatian Mix', age:3, color:'White/Black Spotted', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Karen Espiritu', contact_number:'0934-890-1234', barangay:'Dacanlao', address:'Block 7', vaccination_status:'Due Soon', last_vaccination_date:'2024-08-20', next_vaccination_date:'2025-08-20', status:'Active', impound_status:'None', registration_date:'2024-06-05' , pet_tag_id:'PRP-0004' },
      ...
      { id:'PRP-000-00006', owner_id:null, pet_name:'Ranger', species:'Dog', breed:'Aspin', age:3, color:'Brown/White', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Rodrigo Martinez', contact_number:'0941-567-8901', barangay:'Makina', address:'Sitio 2', vaccination_status:'Due Soon', last_vaccination_date:'2024-07-01', next_vaccination_date:'2025-07-01', status:'Active', impound_status:'None', registration_date:'2024-05-10' , pet_tag_id:'PRP-0006' },
