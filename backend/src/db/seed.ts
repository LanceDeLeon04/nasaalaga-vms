...
const seed = async () => {
  ...
  try {
    ...
    const pets = [
      { id:'BLU-0000-00001', owner_id:'OWNER-001', pet_name:'Max', species:'Dog', breed:'Golden Retriever', age:3, color:'Golden', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Cyrus Cruz', contact_number:'0917-123-4567', barangay:'Poblacion 1', address:'123 Main Street', vaccination_status:'Vaccinated', last_vaccination_date:'2025-01-15', next_vaccination_date:'2026-01-15', status:'Active', impound_status:'None', registration_date:'2024-06-10' , pet_tag_id:'BLU-0000-00001' },
      { id:'BLU-0000-00002', owner_id:'OWNER-001', pet_name:'Bella', species:'Dog', breed:'Labrador', age:2, color:'Black', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Cyrus Cruz', contact_number:'0917-123-4567', barangay:'Poblacion 1', address:'123 Main Street', vaccination_status:'Vaccinated', last_vaccination_date:'2025-02-01', next_vaccination_date:'2026-02-01', status:'Active', impound_status:'None', registration_date:'2024-08-15' , pet_tag_id:'BLU-0000-00002' },
      { id:'BLU-0000-00003', owner_id:'OWNER-001', pet_name:'Charlie', species:'Cat', breed:'Persian', age:1, color:'White', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Cyrus Cruz', contact_number:'0917-123-4567', barangay:'Poblacion 1', address:'123 Main Street', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'None', registration_date:'2025-01-20' , pet_tag_id:'BLU-0000-00003' },
      { id:'BLU-0000-00004', owner_id:null, pet_name:'Brownie', species:'Dog', breed:'Aspin', age:4, color:'Brown', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Maria Reyes', contact_number:'0918-234-5678', barangay:'Poblacion 2', address:'Purok 3, Poblacion 2', vaccination_status:'Vaccinated', last_vaccination_date:'2024-11-10', next_vaccination_date:'2025-11-10', status:'Active', impound_status:'None', registration_date:'2024-05-12' , pet_tag_id:'BLU-0000-00004' },
      { id:'BLU-0000-00005', owner_id:null, pet_name:'Luna', species:'Cat', breed:'Puspin', age:2, color:'Gray/White', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Pedro Santos', contact_number:'0919-345-6789', barangay:'Poblacion 3', address:'Purok 2', vaccination_status:'Vaccinated', last_vaccination_date:'2025-01-05', next_vaccination_date:'2026-01-05', status:'Active', impound_status:'None', registration_date:'2024-09-20' , pet_tag_id:'BLU-0000-00005' },
      { id:'BLU-0000-00006', owner_id:null, pet_name:'Lucky', species:'Dog', breed:'Shih Tzu', age:1, color:'Gray', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Carlos Lopez', contact_number:'0921-567-8901', barangay:'Poblacion 4', address:'Purok 5', vaccination_status:'Not Vaccinated', status:'Lost', impound_status:'None', registration_date:'2025-01-08' , pet_tag_id:'BLU-0000-00006' },
      { id:'RED-0000-00001', owner_id:null, pet_name:'Rocky', species:'Dog', breed:'German Shepherd', age:5, color:'Black/Tan', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Ana Garcia', contact_number:'0922-678-9012', barangay:'Poblacion 5', address:'Phase 1', vaccination_status:'Due Soon', last_vaccination_date:'2024-06-15', next_vaccination_date:'2025-06-15', status:'Active', impound_status:'None', registration_date:'2024-04-18' , pet_tag_id:'RED-0000-00001' },
      { id:'BLU-0000-00007', owner_id:null, pet_name:'Mimi', species:'Cat', breed:'Siamese', age:3, color:'Cream/Brown', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Jose Bautista', contact_number:'0923-789-0123', barangay:'Poblacion 6', address:'Block 4', vaccination_status:'Vaccinated', last_vaccination_date:'2024-12-20', next_vaccination_date:'2025-12-20', status:'Active', impound_status:'None', registration_date:'2024-07-22' , pet_tag_id:'BLU-0000-00007' },
      { id:'GRY-0000-00001', owner_id:null, pet_name:'Choco', species:'Dog', breed:'Aspin', age:2, color:'Chocolate', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Rosa Mendoza', contact_number:'0924-890-1234', barangay:'Balimbing', address:'Sitio 1', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'Impounded', impound_reason:'Roaming without owner', impound_date:'2025-01-10', registration_date:'2024-10-05' , pet_tag_id:'GRY-0000-00001' },
      { id:'GRY-0000-00002', owner_id:null, pet_name:'Whiskers', species:'Cat', breed:'Domestic Shorthair', age:4, color:'Orange/White', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Mario Cruz', contact_number:'0925-901-2345', barangay:'Baclas', address:'Purok 2, Baclas', vaccination_status:'Vaccinated', last_vaccination_date:'2024-10-01', next_vaccination_date:'2025-10-01', status:'Active', impound_status:'None', registration_date:'2024-06-30' , pet_tag_id:'GRY-0000-00002' },
      { id:'GRY-0000-00003', owner_id:null, pet_name:'Duke', species:'Dog', breed:'Labrador Mix', age:3, color:'Yellow', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Elena Ramos', contact_number:'0926-012-3456', barangay:'Bambang', address:'Purok 3', vaccination_status:'Vaccinated', last_vaccination_date:'2025-01-20', next_vaccination_date:'2026-01-20', status:'Active', impound_status:'None', registration_date:'2024-08-14' , pet_tag_id:'GRY-0000-00003' },
      { id:'GRY-0000-00004', owner_id:null, pet_name:'Snowball', species:'Cat', breed:'Persian Mix', age:2, color:'White', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Benjamin Torres', contact_number:'0927-123-4567', barangay:'Bisaya', address:'Sitio Bayanan', vaccination_status:'Vaccinated', last_vaccination_date:'2024-11-15', next_vaccination_date:'2025-11-15', status:'Active', impound_status:'None', registration_date:'2024-07-01' , pet_tag_id:'GRY-0000-00004' },
      { id:'PRP-0000-00001', owner_id:null, pet_name:'Rex', species:'Dog', breed:'Rottweiler', age:4, color:'Black/Tan', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Carla Dela Cruz', contact_number:'0928-234-5678', barangay:'Cahil', address:'Purok 4, Cahil', vaccination_status:'Due Soon', last_vaccination_date:'2024-05-10', next_vaccination_date:'2025-05-10', status:'Active', impound_status:'None', registration_date:'2024-03-22' , pet_tag_id:'PRP-0000-00001' },
      { id:'PRP-0000-00002', owner_id:null, pet_name:'Cleo', species:'Cat', breed:'Siamese Mix', age:1, color:'Cream', gender:'Female', is_spayed:false, is_neutered:false, owner_name:'Fernando Aquino', contact_number:'0929-345-6789', barangay:'Calantas', address:'Purok 1', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'None', registration_date:'2025-02-01' , pet_tag_id:'PRP-0000-00002' },
      { id:'BLU-0000-00008', owner_id:null, pet_name:'Buddy', species:'Dog', breed:'Beagle', age:2, color:'Tricolor', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Gloria Navarro', contact_number:'0930-456-7890', barangay:'Caluangan', address:'Phase 2', vaccination_status:'Vaccinated', last_vaccination_date:'2024-09-05', next_vaccination_date:'2025-09-05', status:'Active', impound_status:'None', registration_date:'2024-05-18' , pet_tag_id:'BLU-0000-00008' },
      { id:'RED-0000-00002', owner_id:null, pet_name:'Pepper', species:'Cat', breed:'Puspin', age:3, color:'Black', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Hector Villanueva', contact_number:'0931-567-8901', barangay:'Camastilisan', address:'Sitio 3', vaccination_status:'Vaccinated', last_vaccination_date:'2024-12-01', next_vaccination_date:'2025-12-01', status:'Active', impound_status:'None', registration_date:'2024-08-10' , pet_tag_id:'RED-0000-00002' },
      { id:'BLU-0000-00009', owner_id:null, pet_name:'Goldie', species:'Dog', breed:'Aspin', age:5, color:'Golden', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Imelda Soriano', contact_number:'0932-678-9012', barangay:'Coral Ni Bacal', address:'Purok 1, Coral Ni Bacal', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'None', registration_date:'2024-04-25' , pet_tag_id:'BLU-0000-00009' },
      { id:'PRP-0000-00003', owner_id:null, pet_name:'Tigger', species:'Cat', breed:'Tabby', age:2, color:'Orange Striped', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Jaime Mercado', contact_number:'0933-789-0123', barangay:'Coral Ni Lopez', address:'Purok 4', vaccination_status:'Vaccinated', last_vaccination_date:'2025-01-08', next_vaccination_date:'2026-01-08', status:'Active', impound_status:'None', registration_date:'2024-10-12' , pet_tag_id:'PRP-0000-00003' },
      { id:'PRP-0000-00004', owner_id:null, pet_name:'Bolt', species:'Dog', breed:'Dalmatian Mix', age:3, color:'White/Black Spotted', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Karen Espiritu', contact_number:'0934-890-1234', barangay:'Dacanlao', address:'Block 7', vaccination_status:'Due Soon', last_vaccination_date:'2024-08-20', next_vaccination_date:'2025-08-20', status:'Active', impound_status:'None', registration_date:'2024-06-05' , pet_tag_id:'PRP-0000-00004' },
      { id:'BLU-0000-00010', owner_id:null, pet_name:'Shadow', species:'Dog', breed:'Labrador', age:4, color:'Black', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Lorenzo Bautista', contact_number:'0935-901-2345', barangay:'Dila', address:'Sitio Pulo', vaccination_status:'Vaccinated', last_vaccination_date:'2024-10-15', next_vaccination_date:'2025-10-15', status:'Active', impound_status:'None', registration_date:'2024-07-19' , pet_tag_id:'BLU-0000-00010' },
      { id:'PRP-0000-00005', owner_id:null, pet_name:'Misty', species:'Cat', breed:'Puspin', age:1, color:'Gray', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Marilou Fernandez', contact_number:'0936-012-3456', barangay:'Loma', address:'Purok 2, Loma', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'None', registration_date:'2025-01-15' , pet_tag_id:'PRP-0000-00005' },
      { id:'RED-0000-00003', owner_id:null, pet_name:'Zeus', species:'Dog', breed:'German Shepherd Mix', age:6, color:'Black/Tan', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Napoleon Castro', contact_number:'0937-123-4567', barangay:'Lumbang Calzada', address:'Purok 6', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'Impounded', impound_reason:'Aggressive behavior', impound_date:'2025-01-08', registration_date:'2024-02-28' , pet_tag_id:'RED-0000-00003' },
      { id:'BLU-0000-00011', owner_id:null, pet_name:'Coco', species:'Cat', breed:'Domestic Shorthair', age:2, color:'Brown Tabby', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Olivia Santos', contact_number:'0938-234-5678', barangay:'Lumbang Na Bata', address:'Purok 3, Lumbang Na Bata', vaccination_status:'Vaccinated', last_vaccination_date:'2024-11-20', next_vaccination_date:'2025-11-20', status:'Active', impound_status:'None', registration_date:'2024-09-08' , pet_tag_id:'BLU-0000-00011' },
      { id:'BLU-0000-00012', owner_id:null, pet_name:'Max Jr', species:'Dog', breed:'Shih Tzu', age:2, color:'White/Brown', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Pablo Reyes', contact_number:'0939-345-6789', barangay:'Lumbang Na Matanda', address:'Purok 2', vaccination_status:'Vaccinated', last_vaccination_date:'2025-02-05', next_vaccination_date:'2026-02-05', status:'Active', impound_status:'None', registration_date:'2024-11-30' , pet_tag_id:'BLU-0000-00012' },
      { id:'GRY-0000-00005', owner_id:null, pet_name:'Lily', species:'Cat', breed:'Persian', age:3, color:'White', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Queenie Villanueva', contact_number:'0940-456-7890', barangay:'Madalunot', address:'Block 1', vaccination_status:'Vaccinated', last_vaccination_date:'2024-12-10', next_vaccination_date:'2025-12-10', status:'Active', impound_status:'None', registration_date:'2024-08-25' , pet_tag_id:'GRY-0000-00005' },
      { id:'PRP-0000-00006', owner_id:null, pet_name:'Ranger', species:'Dog', breed:'Aspin', age:3, color:'Brown/White', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Rodrigo Martinez', contact_number:'0941-567-8901', barangay:'Makina', address:'Sitio 2', vaccination_status:'Due Soon', last_vaccination_date:'2024-07-01', next_vaccination_date:'2025-07-01', status:'Active', impound_status:'None', registration_date:'2024-05-10' , pet_tag_id:'PRP-0000-00006' },
      { id:'GRY-0000-00006', owner_id:null, pet_name:'Princess', species:'Cat', breed:'Siamese', age:4, color:'Cream/Chocolate', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Susan Dela Rosa', contact_number:'0942-678-9012', barangay:'Matipok', address:'Sitio 5, Matipok', vaccination_status:'Vaccinated', last_vaccination_date:'2024-09-18', next_vaccination_date:'2025-09-18', status:'Active', impound_status:'None', registration_date:'2024-06-14' , pet_tag_id:'GRY-0000-00006' },
      { id:'GRY-0000-00007', owner_id:null, pet_name:'Samson', species:'Dog', breed:'Labrador', age:5, color:'Chocolate', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Teresita Cruz', contact_number:'0943-789-0123', barangay:'Munting Coral', address:'Purok 7', vaccination_status:'Vaccinated', last_vaccination_date:'2025-01-25', next_vaccination_date:'2026-01-25', status:'Active', impound_status:'None', registration_date:'2024-04-02' , pet_tag_id:'GRY-0000-00007' },
      { id:'GRY-0000-00008', owner_id:null, pet_name:'Kitty', species:'Cat', breed:'Puspin', age:1, color:'Black/White', gender:'Female', is_spayed:false, is_neutered:false, owner_name:'Ulysses Ramos', contact_number:'0944-890-1234', barangay:'Niyugan', address:'Phase 3', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'None', registration_date:'2025-02-10' , pet_tag_id:'GRY-0000-00008' },
      { id:'PRP-0000-00007', owner_id:null, pet_name:'Scout', species:'Dog', breed:'Beagle Mix', age:2, color:'Brown/White', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Victoria Flores', contact_number:'0945-901-2345', barangay:'Pantay', address:'Purok 1, Pantay', vaccination_status:'Vaccinated', last_vaccination_date:'2024-10-30', next_vaccination_date:'2025-10-30', status:'Active', impound_status:'None', registration_date:'2024-07-08' , pet_tag_id:'PRP-0000-00007' },
      { id:'RED-0000-00004', owner_id:null, pet_name:'Oreo', species:'Cat', breed:'Domestic Shorthair', age:3, color:'Black/White', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Wanda Diaz', contact_number:'0946-012-3456', barangay:'Puting Bato East', address:'Block 5', vaccination_status:'Vaccinated', last_vaccination_date:'2024-11-05', next_vaccination_date:'2025-11-05', status:'Active', impound_status:'None', registration_date:'2024-09-01' , pet_tag_id:'RED-0000-00004' },
      { id:'RED-0000-00005', owner_id:null, pet_name:'Hazel', species:'Dog', breed:'Aspin', age:4, color:'Hazel/Brown', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Xavier Santiago', contact_number:'0947-123-4567', barangay:'Puting Bato West', address:'Purok 3', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'Impounded', impound_reason:'Found roaming near highway', impound_date:'2025-01-15', registration_date:'2024-05-22' , pet_tag_id:'RED-0000-00005' },
      { id:'RED-0000-00006', owner_id:null, pet_name:'Amber', species:'Cat', breed:'Puspin', age:2, color:'Orange', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Yvonne Torres', contact_number:'0948-234-5678', barangay:'Quisumbing', address:'Sitio 4', vaccination_status:'Vaccinated', last_vaccination_date:'2025-01-12', next_vaccination_date:'2026-01-12', status:'Active', impound_status:'None', registration_date:'2024-10-18' , pet_tag_id:'RED-0000-00006' },
      { id:'RED-0000-00007', owner_id:null, pet_name:'Bruno', species:'Dog', breed:'Rottweiler Mix', age:3, color:'Black', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Zenaida Perez', contact_number:'0949-345-6789', barangay:'Salong', address:'Purok 2, Salong', vaccination_status:'Due Soon', last_vaccination_date:'2024-06-20', next_vaccination_date:'2025-06-20', status:'Active', impound_status:'None', registration_date:'2024-04-10' , pet_tag_id:'RED-0000-00007' },
      { id:'RED-0000-00008', owner_id:null, pet_name:'Mittens', species:'Cat', breed:'Domestic Longhair', age:5, color:'Calico', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Adolfo Aquino', contact_number:'0950-456-7890', barangay:'San Rafael', address:'Purok 8', vaccination_status:'Vaccinated', last_vaccination_date:'2024-08-14', next_vaccination_date:'2025-08-14', status:'Active', impound_status:'None', registration_date:'2024-03-30' , pet_tag_id:'RED-0000-00008' },
      { id:'RED-0000-00009', owner_id:null, pet_name:'Ace', species:'Dog', breed:'Aspin', age:1, color:'White', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Brigida Navarro', contact_number:'0951-567-8901', barangay:'Sinisian', address:'Block 2', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'None', registration_date:'2025-02-05' , pet_tag_id:'RED-0000-00009' },
      { id:'PRP-0000-00008', owner_id:null, pet_name:'Pearl', species:'Cat', breed:'Ragdoll Mix', age:3, color:'White/Gray', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Cornelio Bautista', contact_number:'0952-678-9012', barangay:'Taklang Anak', address:'Purok 3, Taklang Anak', vaccination_status:'Vaccinated', last_vaccination_date:'2024-12-22', next_vaccination_date:'2025-12-22', status:'Active', impound_status:'None', registration_date:'2024-09-12' , pet_tag_id:'PRP-0000-00008' },
      { id:'RED-0000-00010', owner_id:null, pet_name:'Cooper', species:'Dog', breed:'Labrador Mix', age:2, color:'Brown', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Dolores Cruz', contact_number:'0953-789-0123', barangay:'Talisay', address:'Purok 9', vaccination_status:'Vaccinated', last_vaccination_date:'2025-01-18', next_vaccination_date:'2026-01-18', status:'Active', impound_status:'None', registration_date:'2024-11-08' , pet_tag_id:'RED-0000-00010' },
      { id:'GRY-0000-00009', owner_id:null, pet_name:'Dusty', species:'Cat', breed:'Puspin', age:4, color:'Gray', gender:'Male', is_spayed:false, is_neutered:true, owner_name:'Ernesto Santos', contact_number:'0954-890-1234', barangay:'Tamayo', address:'Sitio 5', vaccination_status:'Due Soon', last_vaccination_date:'2024-09-01', next_vaccination_date:'2025-09-01', status:'Active', impound_status:'None', registration_date:'2024-06-20' , pet_tag_id:'GRY-0000-00009' },
      { id:'PRP-0000-00009', owner_id:null, pet_name:'Ginger', species:'Dog', breed:'Chow Chow Mix', age:3, color:'Red/Orange', gender:'Female', is_spayed:true, is_neutered:false, owner_name:'Felicitas Reyes', contact_number:'0955-901-2345', barangay:'Timbain', address:'Purok 4, Timbain', vaccination_status:'Vaccinated', last_vaccination_date:'2024-10-28', next_vaccination_date:'2025-10-28', status:'Active', impound_status:'None', registration_date:'2024-07-15' , pet_tag_id:'PRP-0000-00009' },
      { id:'PRP-0000-00010', owner_id:null, pet_name:'Sparky', species:'Dog', breed:'Aspin', age:2, color:'Black', gender:'Male', is_spayed:false, is_neutered:false, owner_name:'Gregorio Flores', contact_number:'0956-012-3456', barangay:'Bagong Tubig', address:'Block 6', vaccination_status:'Not Vaccinated', status:'Active', impound_status:'For Adoption', impound_reason:'Owner surrendered', impound_date:'2025-01-20', registration_date:'2024-12-01' , pet_tag_id:'PRP-0000-00010' },
    ];
    ...
    // ── Livestock Mortality ─────────────────────────────────────────────────
    // Clear the table on every seed run so stale/duplicate rows never accumulate
    await client.query(`TRUNCATE TABLE livestock_mortality RESTART IDENTITY`);
    ...
    const lostFound = [
      ...
      // ── Lost livestock (owner-filed, awaiting BAHW validation) ──
      { id: 'LF-101', pet_id: 'LS-001', pet_name: 'Cattle (LS-001)', species: 'Cattle', breed: 'Brahman', color: 'Gray', type: 'Lost', reported_by: 'Aeden Aranez', reported_by_role: 'livestockOwner', owner_id: 'OWNER-002', contact_number: '0918-234-5678', last_seen_location: 'Near rice field, Purok 3', barangay: 'Poblacion 1', date_reported: '2026-09-20', description: '2 gray Brahman heads slipped out of the pen overnight.', status: 'Open' },
      { id: 'LF-102', pet_id: 'LS-002', pet_name: 'Swine (LS-002)', species: 'Swine', breed: 'Large White', color: 'Pink/White', type: 'Lost', reported_by: 'Aeden Aranez', reported_by_role: 'livestockOwner', owner_id: 'OWNER-002', contact_number: '0918-234-5678', last_seen_location: 'Farm Road', barangay: 'Poblacion 1', date_reported: '2026-09-22', description: '3 pigs missing after the fence broke.', status: 'Open' },
    ];
